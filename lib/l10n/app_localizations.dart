...
abstract class AppLocalizations {
  ...
  /// No description provided for @backupModeOriginal.
  ///
  /// In ko, this message translates to:
  /// **'기록과 원본 첨부'**
  String get backupModeOriginal;

  /// No description provided for @backupModeOriginalDescription.
  ///
  /// In ko, this message translates to:
  /// **'복원에 가장 안전하며 저장 공간을 가장 많이 사용합니다.'**
  String get backupModeOriginalDescription;

  /// No description provided for @backupModeReduced.
  ///
  /// In ko, this message translates to:
  /// **'기록과 용량을 줄인 첨부'**
  String get backupModeReduced;

  /// No description provided for @backupModeReducedDescription.
  ///
  /// In ko, this message translates to:
  /// **'가능하면 최적화 사진을 사용하고, 약봉투·예방접종 수첩은 원본 품질을 지킵니다.'**
  String get backupModeReducedDescription;

  /// No description provided for @backupModeRecordsOnly.
  ///
  /// In ko, this message translates to:
  /// **'기록만'**
  String get backupModeRecordsOnly;

  /// No description provided for @backupModeRecordsOnlyDescription.
  ///
  /// In ko, this message translates to:
  ...
  /// No description provided for @photoSyncHelpQuestion.
  ///
  /// In ko, this message translates to:
  /// **'사진은 왜 다른 기기에서 안 보여요?'**
  String get photoSyncHelpQuestion;

  /// No description provided for @photoSyncHelpAnswer.
  ///
  /// In ko, this message translates to:
  /// **'가족 공유는 먼저 텍스트 기록에 집중하고 있어 사진은 첨부한 기기에만 저장됩니다. 중요한 사진은 원본 첨부를 포함한 백업 파일로 따로 보관해 주세요.'**
  String get photoSyncHelpAnswer;

  /// No description provided for @missingDataHelpQuestion.
  ///
  /// In ko, this message translates to:
  /// **'기록이 적으면 왜 ‘평소보다 적음’으로 판단하지 않나요?'**
  String get missingDataHelpQuestion;

  /// No description provided for @missingDataHelpAnswer.
  ///
  /// In ko, this message translates to:
  /// **'기록이 없는 것은 실제로 적었던 것이 아니라 입력하지 못한 것일 수 있습니다. MLMD는 불완전한 하루를 실제 감소로 단정하지 않습니다.'**
  String get missingDataHelpAnswer;

  /// No description provided for @quietNotificationHelpQuestion.
  ///
  /// In ko, this message translates to:
  /// **'왜 할 일 알림은 기본적으로 조용한가요?'**
  String get quietNotificationHelpQuestion;

  /// No description provided for @quietNotificationHelpAnswer.
  ///
  /// In ko, this message translates to:
  /// **'돌봄 알림이 아이나 가족을 뜻밖에 깨우지 않도록 하기 위해서예요. 꼭 소리가 필요한 할 일은 만들 때 직접 선택할 수 있습니다.'**
  String get quietNotificationHelpAnswer;

  /// No description provided for @aiSummaryHelpQuestion.
  ///
  /// In ko, this message translates to:
  /// **'AI 정리는 무엇을 보고 작성하나요?'**
  String get aiSummaryHelpQuestion;

  /// No description provided for @aiSummaryHelpAnswer.
  ///
  /// In ko, this message translates to:
  ...
  /// No description provided for @exportBackupPreview.
  ///
  /// In ko, this message translates to:
  /// **'일기 {records}건 · 첨부 {attachments}개\n예상 파일 크기 {size}\n현재 기기에 없는 첨부 {missing}개\n이 백업은 암호화되지 않습니다.'**
  ...
  /// No description provided for @attachmentsToImport.
  ///
  /// In ko, this message translates to:
  /// **'이 기기에 가져올 첨부'**
  String get attachmentsToImport;
  ...
  /// No description provided for @sttNoticeTitle.
  ///
  /// In ko, this message translates to:
  /// **'음성 입력 전 확인'**
  String get sttNoticeTitle;

  /// No description provided for @sttNoticeBody.
  ///
  /// In ko, this message translates to:
  ...
  /// No description provided for @sttNoticeAcceptAction.
  ///
  /// In ko, this message translates to:
  /// **'확인했고 사용'**
  String get sttNoticeAcceptAction;

  /// No description provided for @sttNoticeKeyboardAction.
  ///
  /// In ko, this message translates to:
  /// **'키보드로 입력'**
  String get sttNoticeKeyboardAction;

  /// No description provided for @sttListeningStatus.
  ///
  /// In ko, this message translates to:
  /// **'음성 듣는 중...'**
  String get sttListeningStatus;

  /// No description provided for @sttStopAction.
  ///
  /// In ko, this message translates to:
  /// **'음성 입력 중지'**
  String get sttStopAction;

  /// No description provided for @sttMicButtonTooltip.
  ///
  /// In ko, this message translates to:
  /// **'음성 메모 입력'**
  String get sttMicButtonTooltip;

  /// No description provided for @sttNotSupportedTooltip.
  ///
  /// In ko, this message translates to:
  /// **'현재 환경에서는 음성 입력을 지원하지 않습니다'**
  String get sttNotSupportedTooltip;

  /// No description provided for @pastNoticesTitle.
  ///
  /// In ko, this message translates to:
  /// **'이전에 본 안내'**
  String get pastNoticesTitle;

  /// No description provided for @pastNoticeSttTitle.
  ///
  /// In ko, this message translates to:
  /// **'Android 음성 입력 및 개인정보 처리 고지'**
  String get pastNoticeSttTitle;

  /// No description provided for @pastNoticeStatusAccepted.
  ///
  /// In ko, this message translates to:
  /// **'확인함 · {date}'**
  String pastNoticeStatusAccepted(String date);

  /// No description provided for @pastNoticeStatusNotAccepted.
  ///
  /// In ko, this message translates to:
  /// **'미확인'**
  String get pastNoticeStatusNotAccepted;

  /// No description provided for @recheckNoticeAction.
  ///
  /// In ko, this message translates to:
  /// **'고지문 다시 보기'**
  ...
  /// No description provided for @growthChartPersonalTrendDescription.
  ///
  /// In ko, this message translates to:
  /// **'아이의 원본 측정값이 시간에 따라 어떻게 변했는지 봅니다. 측정하지 않은 기간은 추정하지 않습니다.'**
  String get growthChartPersonalTrendDescription;

  /// No description provided for @growthChartHeight.
  ///
  /// In ko, this message translates to:
  /// **'키'**
  String get growthChartHeight;

  /// No description provided for @growthChartWeight.
  ///
  /// In ko, this message translates to:
  /// **'몸무게'**
  String get growthChartWeight;

  /// No description provided for @growthChartHead.
  ///
  /// In ko, this message translates to:
  /// **'머리둘레'**
  String get growthChartHead;

  /// No description provided for @growthChartEmpty.
  ///
  /// In ko, this message translates to:
  /// **'아직 이 그래프에 표시할 측정값이 없습니다.'**
  String get growthChartEmpty;

  /// No description provided for @growthChartPointCount.
  ///
  /// In ko, this message translates to:
  /// **'원본 측정값 {count}개'**
  String growthChartPointCount(int count);

  /// No description provided for @growthChartShowReference.
  ///
  /// In ko, this message translates to:
  /// **'성장도표 함께 보기'**
  String get growthChartShowReference;

  /// No description provided for @growthChartProfileRequired.
  ///
  /// In ko, this message translates to:
  /// **'백분위 계산에는 정확한 생년월일과 성별이 필요합니다.'**
  String get growthChartProfileRequired;

  /// No description provided for @growthChartReferenceUnavailable.
  ///
  /// In ko, this message translates to:
  /// **'현재는 개인 추세만 표시합니다. 아이 프로필과 버전이 확인된 공식 기준 데이터가 준비될 때까지 백분위는 숨깁니다.'**
  String get growthChartReferenceUnavailable;

  /// No description provided for @growthChartPercentileExplanation.
  ///
  /// In ko, this message translates to:
