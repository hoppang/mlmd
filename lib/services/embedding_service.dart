...
final embeddingServiceProvider = Provider<EmbeddingService>((ref) {
  throw UnimplementedError('embeddingServiceProvider가 초기화되지 않았습니다. main.dart에서 재정의해주십시오.');
});
...
class EmbeddingService {
  ...
  Future<void> init() async {
    ...
    print('EmbeddingService successfully initialized.');
  }
