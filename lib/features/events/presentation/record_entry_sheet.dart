...
class _RecordEntrySheetState extends ConsumerState<RecordEntrySheet> {
  ...
  Future<void> _saveTemperature(TemperatureFormResult result) async {
    final selected = _selectedItem;
    if (selected == null || _saving) return;
    setState(() {
      _saving = true;
  ...
  Future<void> _saveHospital(HospitalFormResult result) async {
    final selected = _selectedItem;
    if (selected == null || _saving) return;
    setState(() {
      _saving = true;
  ...
  Future<void> _saveVaccination(VaccinationFormResult result) async {
    final selected = _selectedItem;
    if (selected == null || _saving) return;
    setState(() {
      _saving = true;
  ...
  Future<void> _saveMemo(MemoFormResult result) async {
    final selected = _selectedItem;
    if (selected == null || _saving) return;
    setState(() {
      _saving = true;
