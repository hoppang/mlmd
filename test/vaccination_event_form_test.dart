...
void main() {
  ...
  testWidgets(
    'VaccinationEventForm saves vaccination record with notes, vaccination book photo, and tests KDCA link',
    (tester) async {
      ...
      // Enter note
      await tester.enterText(find.byType(TextField), 'B형간염 2차 접종. 특이사항 없음.');
      ...
      expect(
        ...
        AttachmentType.vaccinationRecord,
      );
