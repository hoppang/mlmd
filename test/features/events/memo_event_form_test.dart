...
void main() {
  ...
  testWidgets('MemoEventForm renders header, text field, typo correction button, save button', (tester) async {
  ...
  testWidgets('MemoEventForm saves MemoRecord when text is entered', (tester) async {
  ...
  testWidgets('MemoEventForm handles STT typo correction, apply, and undo flow', (tester) async {
    await tester.pumpWidget(
      localized(
        MemoEventForm(
          occurredAt: DateTime(2026, 7, 28, 10, 0),
