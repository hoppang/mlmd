...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        find.byKey(const Key('save-tummy-time-button')),
        findsOneWidget,
      );
    },
  );
  ...
  testWidgets(
    'TummyTimeEventForm saves record with duration and note',
    (tester) async {
  ...
  testWidgets(
    'TummyTimeEventForm saves record with no duration (time-only)',
    (tester) async {
      TummyTimeFormResult? result;
      final occurredAt = DateTime(2026, 7, 27, 10, 0);
  ...
  testWidgets(
    'TummyTimeEventForm triggers onBack and onChangeTime callbacks',
    (tester) async {
  ...
  testWidgets(
    'TummyTimeEventForm restores initialRecord fields',
    (tester) async {
      TummyTimeFormResult? result;
      final occurredAt = DateTime(2026, 7, 27, 10, 0);
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        find.byKey(const Key('quick-record-error')),
        findsOneWidget,
      );
      expect(
        find.text('기록을 저장하지 못했어요. 입력 내용은 그대로 유지됩니다.'),
        findsOneWidget,
      );
    },
  );
  ...
  testWidgets(
    'TummyTimeEventForm in English locale shows correct strings',
    (tester) async {
      TummyTimeFormResult? result;
      final occurredAt = DateTime(2026, 7, 27, 10, 0);
